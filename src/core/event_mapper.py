...
from ..utils.schemas import EventAnalysis, EventType, EmotionDelta


class EventMapper:
    """根据消息内容进行快速事件分类和特征提取（适配中文互联网 + 祖安 + 推特中文区用语）"""
    
    # 夸奖关键词（正面/吹捧/网络式夸张）
    PRAISE_KEYWORDS = [
        "牛", "强", "厉害", "666", "优秀", "棒", "美女", "漂亮", "聪明", "灵巧",
        "awesome", "great", "yyds", "神", "绝活", "顶级", "寄", "无敌", "封神",
        "懂的都懂", "太会了", "懂王", "大神", "天花板", "天秀"
    ]
    
    # 贬低关键词（轻度喷/阴阳/抽象贬低）
    INSULT_KEYWORDS = [
        "菜", "垃圾", "废物", "傻", "笨", "蠢", "丑", "弱", "渣", "差",
        "stupid", "dumb", "就这", "寄了", "菜狗", "逆天", "小丑", "抽象",
        "蚌埠住了", "乐死", "懂哥", "懂姐", "低能", "脑瘫", "ylg", "ylgy",
        "ylg懂哥", "纯路人", "建议重开", "回炉重造", "就这水平"
    ]
    
    # 辱骂关键词（严重/祖安式直接对骂 + 推特中文区高频喷）
    ABUSE_KEYWORDS = [
        "滚", "滚蛋", "去死", "该死", "贱", "贪", "抄袭", "骗子", "龟儿子",
        "fuck", "shit", "傻逼", "sb", "nm", "nmsl", "cnm", "草泥马", "妈的",
        "你妈", "你爹", "孝子", "孝孙", "孝死", "逆子", "畜生", "狗东西",
        "狗杂种", "龟孙", "王八蛋", "操你", "日你", "死妈", "死全家",
        "祖安", "祖安人", "嘴臭", "喷子", "键盘侠", "弱智吧", "脑残",
        "建议原地爆炸", "建议回炉重做", "你寄吧谁啊", "你妈死了", "典中典"
    ]
    
    # 逗趣/玩梗关键词（阴阳怪气 + 乐子人 + 抽象风格 + 推特中文区常用）
    TEASE_KEYWORDS = [
        "逗你呢", "开玩笑", "哈哈", "哈", "😂", "笑", "搞笑", "funny", "lol", "haha",
        "乐", "急", "崩", "麻", "赢", "赢麻了", "乐死", "笑死", "蚌埠住了",
        "绷不住了", "典", "典中典", "yygq", "阴阳怪气", "就这？", "理解理解",
        "太会了", "太懂了", "纯纯的", "纯路人发言", "乐子人", "看乐子",
        "吃瓜", "瓜中瓜", "抽象", "抽象话", "整活", "玩梗", "破防", "急了急了",
        "麻了麻了", "绷了", "笑麻", "哈哈哈", "🤣", "😭", "寄", "真寄", "绝绝子", "原神牛逼"
    ]
